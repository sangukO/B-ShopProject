...
<br></br>
                     <div class="reg_main">
		      			...
		      			<div class="form_wrap">
                    	<form action="/goodsEnroll" method="post" id="enrollForm" enctype="multipart/form-data">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<!-- 
                    				<input name="bookPriceFalse" value="0" onkeyup="inputNumberFormat(this)"/>
                    				<input name="bookPrice" type="hidden"  value=${price } ></input>
                    				 -->
                    				 <input name="bookPrice" placeholder="0"/>
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content" id="book_contents">
                    				...
                    				<input type="hidden" id="uploadUser" name="uploadUser" value='${member.memberId }'></input>
                    				<input type="hidden" id="grade" name="grade" value='${member.grade }'></input>
                    			</div>
                    		</div>
                    		<div class="form_section">
                    			<div class="form_section_title">
                   			...
                   			<div class="btn_section">
                   				...
                   				<button type="button" id="enrollBtn" class="btn enroll_btn"  onclick="CheckAddProduct()">등 록</button>             		
	                    	</div> 
...
//			}
		...
		$("#enrollBtn").on("click",function(e){
			...
			if (bookPrice > 1000000) {
				$(".bookPrice_warn").text('책의 가격은 최대 100만원입니다.');
				$(".bookPrice_warn").css('display','block');
				priceCk = false;
			} else if(bookPrice > 0 && bookPrice <= 1000000) {
		...
		$(function() {
		 ...
		 /* 카테고리 */
			...
			/* 대분류 <option> 태그 */
			for(let i = 0; i < cate1Array.length-2; i++){
